-- Shared config for Dimensions addon
...
-- Enable hitscan bullet cross-dimension filtering
DimensionsConfig.BulletFilter = false

-- Enable damage cross-dimension filtering
DimensionsConfig.DamageFilter = true
